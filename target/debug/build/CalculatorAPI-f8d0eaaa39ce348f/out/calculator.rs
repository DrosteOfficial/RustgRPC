...
pub mod calculator_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn add(
            &mut self,
            request: impl tonic::IntoRequest<super::CalculationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CalculationResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut().insert(GrpcMethod::new("calculator.Calculator", "Add"));
...
pub mod calculator_server {
    ...
    pub trait Calculator: Send + Sync + 'static {
        async fn add(
            &self,
            request: tonic::Request<super::CalculationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CalculationResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/calculator.Calculator/Add" => {
                    ...
                    impl<
                        T: Calculator,
                    > tonic::server::UnaryService<super::CalculationRequest>
                    for AddSvc<T> {
                        type Response = super::CalculationResponse;
