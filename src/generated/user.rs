...
impl UserStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            UserStatus::WaitingForConfirmation => "WAITING_FOR_CONFIRMATION",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "WAITING_FOR_CONFIRMATION" => Some(Self::WaitingForConfirmation),
...
pub mod user_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn sign_in(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/user.UserService/SignIn");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("user.UserService", "SignIn"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn sign_out(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/user.UserService/SignOut");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("user.UserService", "SignOut"));
            self.inner.unary(req, path, codec).await
        }
    }
}
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/user.UserService/SignIn" => {
                    #[allow(non_camel_case_types)]
                    struct SignInSvc<T: UserService>(pub Arc<T>);
                    impl<
                        T: UserService,
                    ...
                    for SignInSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UserService>::sign_in(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/user.UserService/SignOut" => {
                    #[allow(non_camel_case_types)]
                    struct SignOutSvc<T: UserService>(pub Arc<T>);
                    impl<
                        T: UserService,
                    ...
                    for SignOutSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UserService>::sign_out(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
